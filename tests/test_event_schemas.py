...
class TestSchemaField:
    ...
    def test_schema_field_creation(self):
        ...
        schema_field = SchemaField(
            name="test", field_descriptor=field_desc, required=True
        )
    ...
    def test_schema_field_with_default(self):
        ...
        schema_field = SchemaField(
            name="test", field_descriptor=field_desc, default="default"
        )
...
class TestSchemaFactory:
    ...
    def test_create_schema_with_base_classes(self):
        ...
        fields = {"name": StringField(data_key="name")}
...
class TestSchemaValidator:
    ...
    def test_validate_data_success(self):
        ...
        is_valid, validated_data, errors = SchemaValidator.validate_data(
            TestSchema, data
        )
...
class TestContainerEventSchema:
    ...
    def test_container_schema_missing_required(self):
        ...
        with pytest.raises(
            ValueError, match="Required field 'container_id' is missing"
        ):
