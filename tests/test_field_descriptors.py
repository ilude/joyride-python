...
class TestEventField:
    ...
    def test_required_field_validation(self):
        ...
        with pytest.raises(ValueError, match="Required field 'required_key' is missing"):
    ...
    def test_custom_validator(self):
        ...
        class TestEvent:
            positive_field = EventField("pos_key", field_type=int, validator=positive_validator)
...
class TestChoiceField:
    ...
    def test_choice_field_with_custom_validator(self):
        ...
        class TestEvent:
            status_field = ChoiceField("status", choices=["OK", "ERROR", "WARN"], validator=uppercase_validator)
        ...
        class TestEvent2:
            status_field = ChoiceField("status", choices=["ok", "error"], validator=uppercase_validator)
