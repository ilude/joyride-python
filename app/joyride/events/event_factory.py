...
class EventFactory:
    ...
    def create_event(
        ...
        **kwargs
        ...
        if event_category == 'container':
            return cls._create_container_event_direct(event_class, event_type, source, timestamp, **kwargs)
        elif event_category == 'dns':
            return cls._create_dns_event_direct(event_class, event_type, source, timestamp, **kwargs)
        elif event_category == 'error':
            return cls._create_error_event_direct(event_class, event_type, source, timestamp, **kwargs)
        elif event_category == 'file':
            return cls._create_file_event_direct(event_class, event_type, source, timestamp, **kwargs)
        elif event_category == 'health':
            return cls._create_health_event_direct(event_class, event_type, source, timestamp, **kwargs)
        elif event_category == 'node':
            return cls._create_node_event_direct(event_class, event_type, source, timestamp, **kwargs)
        elif event_category == 'system':
            return cls._create_system_event_direct(event_class, event_type, source, timestamp, **kwargs)
        else:
            raise ValueError(f"Unsupported event category: {event_category}")
    
    @classmethod
    def _create_container_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    @classmethod
    def _create_dns_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    @classmethod
    def _create_error_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    @classmethod
    def _create_file_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    @classmethod
    def _create_health_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    @classmethod
    def _create_node_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    @classmethod
    def _create_system_event_direct(cls, event_class, event_type, source, timestamp, **kwargs):
    ...
    def create_from_schema(
        ...
        raise NotImplementedError("Schema-based creation not implemented in simplified factory")
    ...
    def validate_event_data(
        ...
        **kwargs
        ...
        required_fields = {
            ...
            'health': ['component'],  # health_status will default, check_name will default
        ...
        if missing_fields:
            raise ValueError(f"Event validation failed: missing required fields: {', '.join(missing_fields)}")
