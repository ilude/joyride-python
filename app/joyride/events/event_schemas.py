...
class EventSchema(metaclass=EventSchemaMeta):
            ...
            if field_name in kwargs:
                ...
                try:
                    ...
                    if schema_field.required and schema_field.default is None:
                        raise ValueError(f"Invalid value for required field '{field_name}': {e}")
    ...
    def get_required_fields(cls) -> List[str]:
        ...
        return [
            name for name, field in cls._schema_fields.items()
            if field.required
        ]
    ...
    def create_schema(
        ...
        for field_name, field_def in fields.items():
            if isinstance(field_def, EventField):
                ...
                raise ValueError(f"Invalid field definition for '{field_name}': {field_def}")
...
class SchemaValidator:
    ...
    @staticmethod
    def merge_schemas(
        schema1: Type[EventSchema],
        schema2: Type[EventSchema],
        name: str
    ) -> Type[EventSchema]:
        """
