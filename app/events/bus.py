...
class JoyrideEventBus:
    ...
    def get_subscriptions(self, event_type: Optional[Type['JoyrideEvent']] = None) -> List['JoyrideEventSubscription']:
        """
    ...
    def clear_subscriptions(self, event_type: Optional[Type['JoyrideEvent']] = None) -> int:
        """
