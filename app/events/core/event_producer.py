...
This module defines the JoyrideEventProducer abstract class that all
...
if TYPE_CHECKING:
    ...
    from .event_bus import JoyrideEventBus
...
class JoyrideEventProducer(ABC):
    ...
    def __init__(self, name: str):
        ...
        self._name = name
        self._running = False
        self._event_bus: Optional["JoyrideEventBus"] = None
    ...
    def set_event_bus(self, event_bus: "JoyrideEventBus") -> None:
        """
