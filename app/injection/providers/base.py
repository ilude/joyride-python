...
class JoyrideDependency:
    ...
    def __post_init__(self):
        ...
        if not (isinstance(self.type_hint, type) or
                hasattr(self.type_hint, '__origin__') or  # Generic types like Optional[str]
                hasattr(self.type_hint, '__module__')):   # Other typing constructs
