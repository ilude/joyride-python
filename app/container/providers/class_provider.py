...
from .base import JoyrideProvider, JoyrideDependency, JoyrideDependencyResolutionError, JoyrideLifecycleType, T
...
class JoyrideClassProvider(JoyrideProvider[T]):
    ...
    def __init__(self, name: str, cls: Type[T], lifecycle: JoyrideLifecycleType = JoyrideLifecycleType.FACTORY):
    ...
    def _analyze_dependencies(self) -> List[JoyrideDependency]:
        ...
        for param_name, param in sig.parameters.items():
            ...
            dependencies.append(JoyrideDependency(
                name=param_name,
                type_hint=type_hint,
                required=required,
